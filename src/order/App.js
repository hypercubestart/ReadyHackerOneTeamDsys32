...
class Item extends Component {
  render () {
    return <div onClick = {() => this.props.callback(this.props.data.itemId, 1, 1)} style = {{position: "relative", width: "30%", minWidth: "250px", height: "170px", border: "3px solid #527aff", borderRadius: "15px", padding: "15px 25px 15px 25px", marginRight: "15px"}}>
      <div>
